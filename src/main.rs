...
- `get_recent_logs`: Fetch the latest app output.
- `get_errors`: Get captured error-level logs.
- `get_latest_crash`: Get full stack trace of the last crash.

---
Generated by DeckDriod v{}
"#, port, port, port, env!("CARGO_PKG_VERSION"));
